 ...
 * @author Yousra
 */
public class NePasSurveillerPanel extends JPanel {
    private JDialog parent;
    private MainFrame mainFrame;

    public NePasSurveillerPanel(JDialog parent, MainFrame mainFrame) {
        initComponents();
        this.parent = parent;
    ...
    private void validerActionPerformed(ActionEvent e) {
        ...
        String sid = "";
        try {
            pos = Integer.parseInt(textField_ID.getText());
        ...
        Object[][] fav = Main.game.getFav();
        int n = fav.length;

        if (pos > 0 && pos <= n){
            Main.game.removeFav(pos);
            mainFrame.mettreAjourTableauFavoris(Main.game.getFav());
            parent.dispose();
        }
        else{
            System.out.println("number out of bound");
            JOptionPane.showMessageDialog(null, "Num non valide");
        }
    ...
    private void initComponents() {
        ...
        //---- label3 ----
        label3.setText("Ne plus surveiller Action");
